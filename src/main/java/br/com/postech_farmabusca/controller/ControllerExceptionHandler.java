...
import br.com.postech_farmabusca.commoms.exception.StandardError;
import org.springframework.web.bind.annotation.ControllerAdvice;

import br.com.postech_farmabusca.commoms.exception.*;
...
public class ControllerExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    @ResponseBody
    public StandardError handleInvalidCredentialsException(
    ...
    @ResponseBody
    public StandardError handleEmailAlreadyExistsException(
    ...
    @ResponseBody
    public StandardError handleForbiddenException(
